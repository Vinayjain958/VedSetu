...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (!process.env.GEMINI_API_KEY) {
      ...
      let fallbackReply =
        "Namaste! 🙏 I am your Vedsetu Vedic Assistant. (To enable live Gemini AI generation, please provide your GEMINI_API_KEY in the Vercel environment settings).\n\n";
...
6. Keep responses clear, concise, and structured with bullet points. Avoid excessive verbosity.\`;
    ...
    if (lowerQuery.includes("astro") || lowerQuery.includes("kundali") || lowerQuery.includes("horoscope") || lowerQuery.includes("muhurat") || lowerQuery.includes("dosha") || lowerQuery.includes("marriage") || lowerQuery.includes("career")) {
